...
2. Install sql patch file, preferably by phpMyAdmin then add sql patch to zen (as recommended in the forum). Please note that the latest zencart has updated mySQL, please use V1.54 install file instead.
