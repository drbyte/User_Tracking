...
if (isset($_GET['SpiderYes'])) {
	if ($_GET['SpiderYes'] == 'ShowSpiders') {
		$displaySpider = true;
	} elseif ($_GET['SpiderYes'] == 'HideSpiders') {
		$displaySpider = false;
	}
} else {
	$displaySpider = false;
...
<table border="0" width="100%" cellspacing="0" cellpadding="2">
  <tr>
	...
	<?php /*Start User Tracking - Incorporate Time Calculations 1 of 2 */ ?>
    <td class="dataTableContent" colspan="2" valign="top"><?php $dt=time() - $ut['value']['end_time']; printf("%02d:%02d:%02d",$dt/3600, ($dt % 3600)/60, $dt % 60); /*echo date('H:i:s', (time() - $ut['value']['end_time']+ 28800));*/ ?></td>
	<?php /*End User Tracking - Incorporate Time Calculations 1 of 2 */ ?>
  </tr>
  <tr>
	...
	<?php /*Start User Tracking - Incorporate Time Calculations 2 of 2 */ ?>
    <td class="dataTableContent" colspan="2" valign="top"><?php $dt=$ut['value']['end_time'] - $ut['value']['time_entry']; printf("%02d:%02d:%02d",$dt/3600, ($dt % 3600)/60, $dt % 60); /*echo date('H:i:s', ($ut['value']['end_time'] - $ut['value']['time_entry'] + 28800));*/ ?><?php /*End User Tracking - Incorporate Time Calculations 2 of 2 */ ?>
</td>
</table>
        </td>
                          </tr>
